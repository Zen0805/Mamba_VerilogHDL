...
(
    ...
    // --- BO CHON CHE DO ---
    // 0: Idle (nghi), 1: Linear, 2: Conv, 3: Scan
    input [2:0] mode_select, 

    // ============================================================
    // 1. GIAO DIEN LINEAR (Che do 1)
    // ============================================================
    input lin_start,
    input lin_en,
    input [15:0] lin_len,
    ...
    // ============================================================
    // 3. GIAO DIEN SCAN CORE (Che do 3)
    // ============================================================
    input scan_start,
    input scan_en,
    input scan_clear_h,
    ...
    // --- DAY NOI BO ---
    wire [255:0] pe_result_common; // Output chung tu 16 PE
    ...
    // Day MUX (chon nguon dieu khien cho PE)
    reg [1:0] mux_pe_op;
    reg       mux_pe_clr;
    ...
    Conv1D_Layer u_conv (
        ...
        // Giao dien PE (moi them vao module Conv)
    ...
    Softplus_Unit_PWL_7F u_softplus (
        .clk(clk),
